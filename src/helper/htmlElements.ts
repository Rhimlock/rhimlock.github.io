...
export const spanTime = document.getElementById("worldTime") as HTMLParagraphElement;
export const spanMouse = document.getElementById("mousePos") as HTMLParagraphElement;
